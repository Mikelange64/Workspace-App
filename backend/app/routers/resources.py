...
from app.utils import process_file, upload_file, delete_file, get_resource_by_id
...
def upload_resource_file(
    ...
    try:
        processed_bytes, file_key, mime = process_file(content)
    except ValueError as err:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail="Invalid file. Please upload a valid file type (PDF, DOCX, ODT, PPT, PPTX, XLS, XLXS)",
        ) from err
